...
export default function Calculator6({ result, callback }: any) {
    ...
    >
      ...
      >
        ...
        <div className="flex h-[60px] w-full items-center justify-end rounded-md bg-neutral-900 px-3 text-4xl text-white">
          {Number(result.lot) != 0 && Number(result2) == 0
            ? Number(result.lot).toLocaleString()

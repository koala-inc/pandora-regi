...
export default function Calculator8({ result, time, callback }: any) {
  ...
  return (
    ...
    >
      <div
        className="relative h-[600px] w-[300px] rounded-md border-4 border-secondary bg-primary p-4"
        onClick={(e) => e.stopPropagation()}
      >
        <div
          className="absolute right-[-15px] top-[-15px] rounded-full border-4 border-secondary"
          onClick={() => {
            result.isTimeCalculator = false;
          }}
        >

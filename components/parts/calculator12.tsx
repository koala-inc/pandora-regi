...
export default function Calculator12({ result, callback }: any) {
    ...
    >
      ...
      >
        <div
          ...
          onClick={() => {
            setResult2("");
            result.isTopNumCalculator = false;
          }}
        >
        ...
        <div className="flex h-[60px] w-full items-center justify-end rounded-md bg-neutral-900 px-3 text-4xl text-white">
          {Number(result.num) != 0 && Number(result2) == 0
            ? Number(result.num).toLocaleString()

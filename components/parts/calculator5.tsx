...
export default function Calculator5({ result, callback }: any) {
  const [result2, setResult2] = useState("");
  const [tax, setTax] = useState(result.isTax);
  const max = 999999999;
